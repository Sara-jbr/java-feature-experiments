...
/**
 * TechStore Java 21 Edition
 * Demonstrates Java 21 features in a mini product management app.
 */
...
public class TechStoreAppJava21 {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("=====  TechStore v11.0 (Java 21) =====\n");
        ...
        var scopedStoreName = ScopedValue.newInstance("TechStore v11.0");
        ...
        Map<String, Double> sequencedMap = Map.of(
                "Laptop", 2000.0,
                "Monitor", 320.0,
                "Mouse", 45.0
        );
        System.out.println("\n Sequenced products (insertion order maintained):");
        sequencedMap.forEach((k, v) -> System.out.println(k + " -> $" + v));

        System.out.println("\n TechStore v11.0 running with Java 21 LTS features!");
    }
}
